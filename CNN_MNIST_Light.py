...
model.add(Conv2D(filters=64, kernel_size=(5,5), padding='same', strides=1, activation='relu', name='block2_conv1'))
model.add(Conv2D(filters=64, kernel_size=(5,5), padding='same', strides=1, activation='relu', name='block2_conv2'))
model.add(MaxPool2D(pool_size=(2,2), strides=2, name='block2_pool'))
model.add(Flatten())
model.add(Dense(128, activation='relu'))
model.add(Dropout(args.args))  
